...
export const assetTypeEnum = pgEnum('asset_type', ['stock', 'mutual_fund', 'gold', 'silver', 'fd', 'property', 'crypto', 'cash', 'bond', 'liability']);
...
export const holdings = pgTable('holdings', {
  ...
  purchaseDate: timestamp('purchase_date'),  // User-specified historical purchase date
