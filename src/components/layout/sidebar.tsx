      ...
      <div className="border-t border-border-default p-3 relative" ref={menuRef}>
        ...
        >
          <div className="w-8 h-8 rounded-full bg-accent-brass flex items-center justify-center shrink-0">
            <span className="text-bg-base font-bold text-[13px]">HT</span>
          </div>
          {!collapsed && (
            <div className="flex-1 min-w-0">
              <p className="text-[13px] font-medium text-text-primary truncate">Het Tandel</p>
              <p className="text-[11px] text-text-faint truncate">het@example.com</p>
            </div>
          )}
        </button>
