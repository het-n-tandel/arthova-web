...
export const stockHoldings: StockHolding[] = [
  { symbol: 'RELIANCE', name: 'Reliance Industries', sector: 'Energy', quantity: 50, avgCost: 2340, cmp: 2978.45, dayChange: 24.30, dayChangePercent: 0.82, pe: 28.5, marketCap: 2016000, weekHigh52: 3217, weekLow52: 2220, volume: 8542310 },
  { symbol: 'TCS', name: 'Tata Consultancy Services', sector: 'IT', quantity: 30, avgCost: 3200, cmp: 4156.80, dayChange: -18.50, dayChangePercent: -0.44, pe: 32.1, marketCap: 1524000, weekHigh52: 4592, weekLow52: 3311, volume: 2145620 },
  { symbol: 'HDFCBANK', name: 'HDFC Bank', sector: 'Banking', quantity: 100, avgCost: 1450, cmp: 1812.35, dayChange: 12.75, dayChangePercent: 0.71, pe: 20.4, marketCap: 1382000, weekHigh52: 1880, weekLow52: 1363, volume: 12450890 },
  { symbol: 'INFY', name: 'Infosys', sector: 'IT', quantity: 75, avgCost: 1380, cmp: 1892.60, dayChange: -7.20, dayChangePercent: -0.38, pe: 29.8, marketCap: 786000, weekHigh52: 1997, weekLow52: 1358, volume: 6723450 },
  { symbol: 'ICICIBANK', name: 'ICICI Bank', sector: 'Banking', quantity: 120, avgCost: 820, cmp: 1285.90, dayChange: 15.40, dayChangePercent: 1.21, pe: 18.7, marketCap: 904000, weekHigh52: 1362, weekLow52: 875, volume: 9876540 },
  { symbol: 'HINDUNILVR', name: 'Hindustan Unilever', sector: 'FMCG', quantity: 40, avgCost: 2180, cmp: 2534.15, dayChange: 8.60, dayChangePercent: 0.34, pe: 58.2, marketCap: 596000, weekHigh52: 2859, weekLow52: 2172, volume: 1342670 },
  { symbol: 'BHARTIARTL', name: 'Bharti Airtel', sector: 'Telecom', quantity: 60, avgCost: 780, cmp: 1687.50, dayChange: 32.15, dayChangePercent: 1.94, pe: 76.3, marketCap: 1012000, weekHigh52: 1779, weekLow52: 887, volume: 4523890 },
  { symbol: 'ITC', name: 'ITC Limited', sector: 'FMCG', quantity: 200, avgCost: 320, cmp: 468.25, dayChange: 3.80, dayChangePercent: 0.82, pe: 27.1, marketCap: 585000, weekHigh52: 499, weekLow52: 312, volume: 15678900 },
  { symbol: 'SBIN', name: 'State Bank of India', sector: 'Banking', quantity: 150, avgCost: 520, cmp: 832.40, dayChange: -5.60, dayChangePercent: -0.67, pe: 10.2, marketCap: 743000, weekHigh52: 912, weekLow52: 555, volume: 18945670 },
  { symbol: 'WIPRO', name: 'Wipro', sector: 'IT', quantity: 90, avgCost: 390, cmp: 542.80, dayChange: 4.25, dayChangePercent: 0.79, pe: 24.6, marketCap: 284000, weekHigh52: 587, weekLow52: 371, volume: 5432100 },
  { symbol: 'BAJFINANCE', name: 'Bajaj Finance', sector: 'NBFC', quantity: 20, avgCost: 6200, cmp: 7845.30, dayChange: 65.20, dayChangePercent: 0.84, pe: 34.5, marketCap: 486000, weekHigh52: 8192, weekLow52: 5875, volume: 1987650 },
  { symbol: 'TATAMOTORS', name: 'Tata Motors', sector: 'Auto', quantity: 80, avgCost: 610, cmp: 978.65, dayChange: -12.40, dayChangePercent: -1.25, pe: 8.9, marketCap: 362000, weekHigh52: 1085, weekLow52: 575, volume: 11234560 },
  { symbol: 'SUNPHARMA', name: 'Sun Pharmaceutical', sector: 'Pharma', quantity: 55, avgCost: 1020, cmp: 1734.20, dayChange: 22.80, dayChangePercent: 1.33, pe: 38.7, marketCap: 416000, weekHigh52: 1868, weekLow52: 1015, volume: 3456780 },
  { symbol: 'MARUTI', name: 'Maruti Suzuki', sector: 'Auto', quantity: 10, avgCost: 9500, cmp: 12845.60, dayChange: 78.30, dayChangePercent: 0.61, pe: 32.8, marketCap: 402000, weekHigh52: 13420, weekLow52: 9180, volume: 876540 },
  { symbol: 'ASIANPAINT', name: 'Asian Paints', sector: 'Paints', quantity: 35, avgCost: 2850, cmp: 2312.45, dayChange: -28.50, dayChangePercent: -1.22, pe: 52.4, marketCap: 222000, weekHigh52: 3395, weekLow52: 2174, volume: 2345670 },
];
...
export function generatePortfolioHistory(months: number = 12): { date: string; value: number }[] {
  const data: { date: string; value: number }[] = [];
  const now = new Date();
  let value = 3200000; // starting value ~6 months ago

  for (let i = months; i >= 0; i--) {
    const date = new Date(now);
    date.setMonth(date.getMonth() - i);
    // Simulate gradual growth with some volatility
    const monthlyReturn = 0.008 + (Math.random() - 0.4) * 0.02;
