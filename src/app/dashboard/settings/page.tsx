      ...
      <section className="bg-bg-surface border border-border-default rounded-[12px] p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" defaultValue="Het Tandel" className="w-full bg-bg-surface-2 border border-border-default rounded-[6px] px-3 py-2 text-[14px] text-text-primary focus:outline-none focus:border-accent-brass transition-colors" />
          </div>
          <div>
            <label className="text-[12px] text-text-faint block mb-1.5">Email</label>
            <input type="email" defaultValue="het@example.com" className="w-full bg-bg-surface-2 border border-border-default rounded-[6px] px-3 py-2 text-[14px] text-text-primary focus:outline-none focus:border-accent-brass transition-colors" />
          </div>
          <div>
